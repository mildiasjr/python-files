...
def forca_joga(palavr_entra, palavr_chav, letras_list) :
    ...
    while enforcar < 7 and guess_palavra != palavr_chav :
        while True:
              guess_letra = input('\033[10;10H' + 'Adivinhe a letra: ').capitalize()
...
while jogar == True:
    ...
    palavr_entra = palavr_entra.upper()

    # Unpack Operator para transformar a string entrada em uma lista de elementos
    letras_list = [*palavr_entra]

    # Ordena letras em lista de PALAVR_CHAV para comparação
